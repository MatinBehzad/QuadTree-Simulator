...
public class QuadTreeSimulator extends Application {
	 ...
	 * {@link ParticleLocator#start(Stage)} method.
	 */
	...
	public void init() throws Exception {
		...
		canvas.heightProperty().bind(root.heightProperty().subtract(statusBar.heightProperty()).subtract(optionBar.heightProperty()));
		canvas.widthProperty().bind(root.widthProperty().subtract(colorBar.widthProperty()));
		// TODO Complete
	}
	...
	private Region createColorBar() {
		...
		ObjectProperty<Color> colorOption = new SimpleObjectProperty<Color>(Color.BLACK);
		...
		b2.setMinSize(40, 16);
		b3.setMinSize(40, 16);
		b1.setStyle("-fx-border-color: #000000; -fx-border-width: 2px; -fx-background-color: RED");
		b2.setStyle("-fx-border-color: #000000; -fx-border-width: 2px; -fx-background-color: BLACK");
		b3.setStyle("-fx-border-color: #000000; -fx-border-width: 2px; -fx-background-color: GREEN");

		b1.setOnAction(e -> {
			colorOption.set(Color.RED);
		});
		b2.setOnAction(e -> {
			colorOption.set(Color.BLACK);
		});
		b3.setOnAction(e -> {
			colorOption.set(Color.DARKGREEN);
		});

		ToolBar toolbar = new ToolBar();
		toolbar.getItems().addAll(b1, b2, b3);
